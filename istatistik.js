...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .addFields({ name: 'Bot Sahibi', value: `<@449603871929532418> Ardacan Aydoğan`, inline: false})
    ...
    .addFields({ name: '• Bot Kuruluş', value: `02.06.2019`, inline: true})
    .addFields({ name: '• Komut Sayısı', value: `Bilinmiyor`, inline: true})
    .addFields({ name: '• Ping', value: `${client.ws.ping}`, inline: true})
    .setImage("https://cdn.discordapp.com/attachments/783055798229401660/929390925501825024/standard.gif?size=4096")
